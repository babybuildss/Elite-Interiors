...
const projects = [
  ...
  { id: 2, title: 'Café Lumière', category: 'Hospitality', location: 'Delhi', year: '2024', area: '3,200 sq ft', image: '/images/portfolio-dining.png', description: 'An immersive dining experience where Art Deco elegance meets contemporary Indian artistry. The space features hand-painted murals and custom brass lighting fixtures.' },
