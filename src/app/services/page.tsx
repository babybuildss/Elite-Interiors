...
const processSteps = [
  { step: '01', title: 'Discovery', desc: 'An in-depth consultation where we immerse ourselves in your vision, lifestyle, and aspirations. We study your space, understand your needs, and define the project scope with precision.', icon: 'Γùç' },
  { step: '02', title: 'Concept', desc: 'We translate your vision into tangible design concepts through mood boards, 3D visualizations, material palettes, and spatial layouts. Every detail is explored before execution begins.', icon: 'Γùå' },
  { step: '03', title: 'Creation', desc: 'Our master craftsmen, trusted artisans, and project managers bring the design to life with meticulous attention to detail. Weekly updates ensure complete transparency throughout.', icon: 'Γùï' },
  { step: '04', title: 'Reveal', desc: 'The breathtaking moment when your transformed space is unveiled in its full glory. A comprehensive handover with documentation, care guides, and our 10-year warranty.', icon: 'Γûí' },
];
...
const faqs = [
  ...
  { q: 'Do you handle procurement and installation?', a: 'Absolutely. We manage the entire process end-to-end ΓÇö from sourcing materials globally to manufacturing custom furniture and final installation. You never have to coordinate with multiple vendors.' },
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                      ...
                      <Link href="/contact" className="magnetic-btn inline-flex items-center gap-3 text-[#C9A96E] text-xs tracking-[0.2em] uppercase cursor-hover group">
                        Start Your Project <span className="group-hover:translate-x-2 transition-transform duration-300">ΓåÆ</span>
                      </Link>
                    </div>
                  </motion.div>
                </AnimatePresence>
