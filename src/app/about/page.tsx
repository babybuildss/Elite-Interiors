            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <motion.div variants={fadeUp} className="flex flex-col justify-center">
                ...
                <p className="font-[family-name:var(--font-cormorant)] text-white/40 text-lg leading-relaxed mb-8">
                  From a 3-person studio in Mumbai to a 40+ strong team across India, our journey has been fuelled by an unwavering commitment to excellence and a deep understanding that luxury is not about price — it&apos;s about the experience, the emotion, and the story each space tells.
                </p>
          ...
          <motion.div initial="hidden" animate={visionInView ? 'visible' : 'hidden'} variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.15 } } }}>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <motion.div variants={fadeUp} className="glass-card p-10 md:p-12 relative overflow-hidden group">
                ...
                <p className="font-[family-name:var(--font-cormorant)] text-white/40 text-lg leading-relaxed">
                  We envision a future where every Indian home and commercial space reflects the depth and sophistication of its occupants. Through innovation, sustainability, and unwavering quality, we aim to make that vision a reality — one masterpiece at a time.
                </p>
              </motion.div>
            </div>
          </motion.div>
